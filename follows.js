(function ( $ ){
	...
	*/
	...
	var defaultKey		= '32Pf6JadIeU3TeOtpVrbHOZHMUG7rm6X4tZUpvdUP02jF3bP', // Unique master Xively API key to be used as a default
		defaultFeeds	= [1552169494], // Comma separated array of Xively Feed ID numbers
		applicationName	= 'Gallini Vocs Monitor', // Replaces Xively logo in the header
		dataDuration	= '90days', // Default duration of data to be displayed // ref: https://xively.com/dev/docs/api/data/read/historical_data/
		dataInterval	= 10800, // Default interval for data to be displayed (in seconds)
		dataColor		= '0A1922', // CSS HEX value of color to represent data (omit leading #)
